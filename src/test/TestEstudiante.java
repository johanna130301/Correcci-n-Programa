...
public class TestEstudiante {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Listado de Estudiantes ordenados de mayor a menor nota");//Imprimo la funcion ordenarMyor 
        ordenarMayorMenor(estudiantes,n);
        for(Estudiante est:estudiantes){
            System.out.println(est);
        }
        System.out.println("Listado de Estudiantes ordenados de menor a mayor nota");
        ordenarMenorMayor(estudiantes,n);
        for(Estudiante est:estudiantes){
            System.out.println(est);
        }
    ...
    //METODO USADO PARA ORDENAR DE MAYOR A MENOR//
    ...
    //METODO USADO PARA ORDENAR DE MENOR A MAYOR//
    public static void ordenarMenorMayor(Estudiante est[], int not){
        for(int i=0;i<not;i++){
            for(int j=0;j<not-1;j++){
                if(est[j].getNota()>=est[j+1].getNota()){
                    Estudiante aux;
